...
//	@Test(expected = InsufficientBalanceException.class)	
	...
	@Test (expected = InvalidAmountException.class)
	public void openAccountShoulFailForInvalidAmount() {
		
		var accountNumber= bank.openAccount("savings", "Name1", correctPassword, -90);
		
	}
	
	@Test (expected = InvalidAmountException.class)
	public void withdrawAmountShouldFailIfNotAMultipleOf100() {
	
		bank.withdraw(currentAccountNumber, 999, correctPassword);
	}
	
	@Test (expected = InvalidAmountException.class)
	public void depositAmountShouldFailIfNotAMultipleOf100() {
